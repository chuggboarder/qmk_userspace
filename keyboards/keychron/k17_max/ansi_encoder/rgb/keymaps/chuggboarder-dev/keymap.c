...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_104_ansi(
        ...
        KC_DOLLAR,   KC_AMPERSAND,     KC_LBRC,     KC_LCBR,     KC_RCBR,     KC_LBR,     KC_EQL,     KC_ASTR,     KC_RBR,     KC_PLUS,     KC_RBRC,     KC_EXCLAIM,    KC_HASH,   KC_BSPC,            KC_PGUP,  KC_NUM,   KC_PSLS,  KC_PAST,  KC_PMNS,
        KC_TAB,   KC_SCLN,     KC_COMM,     KC_DOT,     KC_P,     KC_Y,     KC_F,     KC_G,     KC_C,     KC_R,     KC_L,     KC_SLS,    KC_AT,  KC_BSLS,            KC_PGDN,  KC_P1,    KC_P2,    KC_P3,    KC_PPLS,
        KC_F13,  KC_A,     KC_O,     KC_E,     KC_U,     KC_I,     KC_D,     KC_H,     KC_T,     KC_N,     KC_S,  KC_MINS,              KC_ENT,             KC_HOME,  KC_P4,    KC_P5,    KC_P6,
        KC_LSFT,            KC_QUOT,     KC_Q,     KC_J,     KC_K,     KC_X,     KC_B,     KC_M,     KC_W,  KC_V,   KC_Z,              KC_RSFT,  KC_F14,              KC_P7,    KC_P8,    KC_P9,    KC_PENT,
    ...
    [WIN_SHIFT] = LAYOUT_104_ansi(
        ...
        KC_DOLLAR,   KC_AMPERSAND,     KC_LBRC,     KC_LCBR,     KC_RCBR,     KC_LBR,     KC_EQL,     KC_asterisk,     KC_RBR,     KC_PLUS,     KC_RBRC,     KC_EXCLAIM,    KC_HASH,   KC_BSPC,            KC_PGUP,  KC_NUM,   KC_PSLS,  KC_PAST,  KC_PMNS,
        KC_TAB,   KC_SCLN,     KC_COMM,     KC_DOT,     KC_P,     KC_Y,     KC_F,     KC_G,     KC_C,     KC_R,     KC_L,     KC_SLS,    KC_AT,  KC_BSLS,            KC_PGDN,  KC_P1,    KC_P2,    KC_P3,    KC_PPLS,
        KC_F13,  KC_A,     KC_O,     KC_E,     KC_U,     KC_I,     KC_D,     KC_H,     KC_T,     KC_N,     KC_S,  KC_MINS,              KC_ENT,             KC_HOME,  KC_P4,    KC_P5,    KC_P6,
        KC_LSFT,            KC_QUOT,     KC_Q,     KC_J,     KC_K,     KC_X,     KC_B,     KC_M,     KC_W,  KC_V,   KC_Z,              KC_RSFT,  KC_F14,              KC_P7,    KC_P8,    KC_P9,    KC_PENT,
        KC_F15,  KC_LALT,  KC_LCTL,                                KC_SPC,                                 KC_RCTL,  KC_RALT, KC_F16,  KC_LWIN,  KC_APP,  MO(WIN_FN),  KC_P0,              KC_PDOT         ),
